  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="mb-5">
        ...
        <input
          type="text"
          defaultValue="Contact Us at Weight Loss MD Today"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col justify-end pb-3">
          ...
          <div className="flex items-center gap-2">
            <input type="checkbox" id="blank-target-cta" defaultChecked className="w-4 h-4 text-[#1447E6] rounded border-slate-300 focus:ring-[#1447E6] focus:ring-offset-0 cursor-pointer" />
