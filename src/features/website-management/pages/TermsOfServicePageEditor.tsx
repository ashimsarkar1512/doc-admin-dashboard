...
export default function TermsOfServicePageEditor() {
  ...
  const fetchData = async () => {
    ...
    try {
      const [heroes, widget, contentRes] = await Promise.all([
        getHeroSectionByPage("TermsOfService").catch(() => []),
        getSideWidgetByPage("TermsOfService").catch(() => []),
        getPolicyPageContent("terms-of-service").catch(() => null)
      ]);
  ...
  const handleSave = async (sectionName?: string) => {
    ...
    try {
      ...
      // Save Content
      if (!sectionName || sectionName === "Terms of Service Content") {
        tasks.push(updatePolicyPageContent("terms-of-service", {
    ...
    <div className="p-4 sm:p-7 space-y-8 min-h-full font-sans pb-20 bg-slate-50">
      ...
      <div className="space-y-6">
        ...
        <PolicyContentSection
          ...
          onSave={() => handleSave("Terms of Service Content")}
          isSaving={savingSection === "Terms of Service Content"}
        />
