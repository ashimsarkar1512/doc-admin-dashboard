...
export function NotEligibleForRefundSection({ setIsDirty }: Props) {
  ...
  return (
    <SectionCard title="Not Eligible for Refund Section">
      <div className="space-y-6">
        <FormInput label="Section Title:" value={title} onChange={(e) => handleTitleChange(e.target.value)} placeholder="Not Eligible for Refund" />
            ...
            <div key={condition.id} className="flex items-center gap-4">
              <div className="flex-1">
                <FormInput
                  ...
                  placeholder={index === 0 ? "Unused days in a billing period after cancellation" : index === 1 ? "Medication already dispensed by pharmacy" : index === 2 ? "Provider consultations already complete" : "Write here..."}
                />
              </div>
              <button
