  ...
  return (
    <div className="w-full p-6 md:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
        ...
        <button className="flex items-center gap-2 bg-[#1447E6] text-white px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors shadow-sm">
          <Plus size={16} />
          Add New Doctor
        </button>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
        ...
        <div className="relative w-full md:w-96">
          ...
          <input
            type="text"
            className="block w-full pl-10 pr-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 bg-slate-50/50"
