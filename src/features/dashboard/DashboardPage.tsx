...
export default function DashboardPage() {
  ...
  return (
    <div className="w-full p-3 sm:p-4 md:px-6 md:pt-4">
      <PageHeader 
      ...
      <div className="mt-6 sm:mt-10">
        <h2 className="text-[15px] sm:text-[18px] font-semibold text-slate-800 mb-3 sm:mb-4">Recent Assessment Activity</h2>
        <PatientTable />
      </div>
    </div>
  );
