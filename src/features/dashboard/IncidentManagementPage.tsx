  ...
  return (
    <div className="w-full p-4 md:p-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
        ...
        <StatCard
          label="Open"
          value={overviewLoading ? undefined : overview?.open}
        />
        <StatCard
          label="Investigating"
          value={overviewLoading ? undefined : overview?.investigating}
        />
        <StatCard
          label="Resolved"
          value={overviewLoading ? undefined : overview?.resolved}
        />
      </div>
                  ...
                  {incidents.map((incident) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Type */}
                        <td
                          className="px-5 py-4 text-slate-800 font-medium max-w-[200px] truncate"
                          title={incident.type}
                        >
                          {incident.type}
                        </td>
                        ...
                        <td className="px-5 py-4 whitespace-nowrap">
                          <span
                            className={`px-2.5 py-1 rounded-full text-xs font-semibold ${sv.className}`}
                          >
                            {sv.label}
                          </span>
                        </td>
                        ...
                        {/* User Involved */}
                        <td
                          className="px-5 py-4 whitespace-nowrap text-slate-600 max-w-[180px] truncate"
                          title={userDisplay}
                        >
                          {userDisplay}
                        </td>
