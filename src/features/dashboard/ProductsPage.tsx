...
import { CATEGORY_OPTIONS } from '@/data/assessments';
import { INITIAL_PRODUCTS, PRESET_PRODUCT_IMAGES } from '@/data/products';
...
export default function ProductsPage() {
  ...
  const [formImage, setFormImage] = useState(PRESET_PRODUCT_IMAGES[0]);
  ...
  return (
    <div className="p-6 md:p-10 w-full space-y-10 font-sans">
      {/* Control Panel (Search & Add Product) */}
      ...
      {/* Reusable Dialog Modal for Product Create/Edit */}
      <Dialog
        isOpen={isModalOpen}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-800">Product image: (required)</label>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="e.g., Diethylpropion"
          ...
          <div className="pt-4 border-t border-gray-100 flex gap-3">
            ...
            <button
              type="submit"
              className="flex-1 py-2.5 bg-[#2563EB] hover:bg-blue-700 text-white rounded-[10px] text-sm font-medium transition-colors"
            >
